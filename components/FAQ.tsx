...
const FAQ: React.FC = () => {
  const faqs = [
    ...
    {
      q: "IT導入補助金は使えますか？",
      a: "現在公開中・準備中の各ツールについて、IT導入補助金の対象化を検討しています。対象範囲や申請時期は確定次第、会員向けに案内します。"
    },
    {
      q: "法改正の情報は最新ですか？",
    ...
    {
      q: "他のコミュニティとの違いは？",
      a: "AIの一般論ではなく、建築確認申請・省エネ対応・設計実務でのAI活用に絞ったコミュニティです。すぐに現場で試せるノウハウと、公開中または開発中の実務支援ツールの情報を提供します。"
    },
    {
      q: "学生プランの対象は？",
