  ...
  const benefits = [
    {
      ...
      desc: "Sena開発の実務AIソフト（図面チェック等）が使い放題。さらに通常3,000円〜のセミナー参加も、アーカイブ視聴もメンバーは全て無料。これだけで会費以上の価値があります。"
    },
    {
      icon: <Clock className="w-8 h-8 text-brand" />,
      title: "業務時間を「半減」できる",
      desc: "AIに単純作業を任せることで、残業時間を劇的に減らせます。空いた時間は、本来やりたかったデザインや、家族との時間に使ってください。"
    },
    {
